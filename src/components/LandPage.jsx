...
const LandPage = () => {
  return (
    <div
    className="container" id='landPage' style={{height : "calc(100vh - 120px)"}}
  >
      ...
      <div className="container" id='text-content'>
        ...
        <button type="button" class="btn btn-dark ">            <Link className="nav-link" to="project" smooth={true} duration={500}>See my work</Link>
        </button>
        <div className="icons">
